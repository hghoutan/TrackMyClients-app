...
import 'package:trackmyclients_app/src/presentation/widgets/drop_down_input.dart';
import 'package:trackmyclients_app/src/presentation/widgets/main_button.dart';
import 'package:trackmyclients_app/src/presentation/widgets/new_client_text_input.dart';
...
class _AddClientScreenState extends ConsumerState<AddClientScreen> {
  ...
  void storeUserData() async {
    if (newClientFormKey.currentState!.validate()) {
      ...
      ref.read(clientControllerProvider).saveClientDataToFirebase(
            context,
            clientData,
            image,
          );
      ref.read(clientControllerProvider).fetchAllClients();
